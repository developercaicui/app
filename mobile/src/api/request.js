...
function getArgs(port,params){
	...
	// if(API.getCookie('isDemo')  && API.getCookie('isDemo') == 'false'){
    ...
    params: params } ,config).then(res => res.data).catch(err => err)
	}
}
...
const server = {
	...
	'appointment' : {
		'url' : '/api/teachsource/opencourse/appointment/data'
	},
	'getappointmentlist' : {
		'url' : '/api/teachsource/opencourse/getappointmentlist/data'
	},
