...
export const getCourseProgres = params => { return axios.get(`http://action.${domain}.com/api/userAction/course/getCourseProgress/v1.0/?${qs.stringify(params)}`, {}).then(res => res.data).catch(err => err) };
