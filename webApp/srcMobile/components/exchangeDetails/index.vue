    ...
    <div class="my-talk-list"> <!-- 用户信息--> 
          ...
          <div class="talk-footer">
              <div class="course-name">
                <div class="tag-video-time" @click="jump_task(data)"><i class="iconfont icon-bofang"></i><span>13:25</span></div>
              </div>
      ...
      <div id="content2" class="reply-list">
        <div class="reply-list-total">全部<span>2</span>条评论</div>
        <div class="cont-list">
           <div class="talk-user clear-fix">
                <div class="takl-user-photo">
                    <img src="../../assets/img/touxiang.png" alt="">
                ...
                <div class="talk-user-message clear-fix">
                    <p class="line-1"><span>张杰先生</span></p>
                    <p class="line-22"><span>2015-12-13 </span><span>14:17</span></p> 
                </div>
            </div>
